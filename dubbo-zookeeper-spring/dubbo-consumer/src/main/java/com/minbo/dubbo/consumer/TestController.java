...
public class TestController {
	...
	public JSONObject testJson(@PathVariable("name") String name) {
		...
		jsonObject.put("sayHello1", testStr);
		return jsonObject;
	}
	...
	public JSONObject testJson2(@PathVariable("name") String name) {
		JSONObject jsonObject = new JSONObject();
		String testStr = demoService.sayHello2(name);
		jsonObject.put("sayHello2", testStr);
		return jsonObject;
	}
}